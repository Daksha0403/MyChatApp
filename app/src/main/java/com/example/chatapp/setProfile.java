...
public class setProfile extends AppCompatActivity {
    ...
    private static int PICK_IAMGE = 123;
    private Uri iamgepath;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mgetuserimage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(intent,PICK_IAMGE);
            }
        });
    ...
    private void sendImagetoStorage()
    {
        ...
        try
        {
           bitmap = MediaStore.Images.Media.getBitmap(getContentResolver(),iamgepath);
        }
        catch (IOException e)
        {
            e.printStackTrace();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==PICK_IAMGE && resultCode==RESULT_OK)
        {
            iamgepath = data.getData();
            mgetuserimageinimageview.setImageURI(iamgepath);
        }
