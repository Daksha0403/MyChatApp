...
public final class ActivityChatBinding implements ViewBinding {
  ...
  private ActivityChatBinding(@NonNull RelativeLayout rootView, @NonNull TabItem calls,
      @NonNull TabItem chat, @NonNull ViewPager fragmentcontainer, @NonNull TabLayout include,
      @NonNull TextView myapptext, @NonNull TabItem status, @NonNull Toolbar toolbar) {
  ...
  public static ActivityChatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.calls;
      TabItem calls = ViewBindings.findChildViewById(rootView, id);
      if (calls == null) {
        break missingId;
      }
      ...
      return new ActivityChatBinding((RelativeLayout) rootView, calls, chat, fragmentcontainer,
          include, myapptext, status, toolbar);
    }
